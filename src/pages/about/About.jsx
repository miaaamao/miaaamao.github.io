      ...
      <Container fluid className='about-wrapper'>
        ...
        <div className='about-right'>
          <p className='home-about-body'>
            Hi, I'm Mia Mao, I graduated from{' '}
            <span
              onMouseEnter={showDukeDiplomaPreview}
              onMouseLeave={hideDukeDiplomaPreview}
              onClick={handleDukeDiplomaModalShow}
            ...
            {dukeIsDiplomaPreviewVisible && (
              <div className='duke-img-preview'>
                <img
                  src={DukeDiplomaPreviewImage}
                  alt='Duke Diploma Preview'
                  style={{ width: '100px', height: 'auto' }}
                />
              </div>
            )}{' '}
            with a MS in Quantitative Management in Business Analytics, Finance Track, and from{' '}
            <span
              onMouseEnter={showUCSBDiplomaPreview}
              onMouseLeave={hideUCSBDiplomaPreview}
              onClick={handleUCSBDiplomaModalShow}
              style={{ cursor: 'pointer', color: '#003660' }}
            >
            ...
            {ucsbIsDiplomaPreviewVisible && (
              <div className='ucsb-img-preview'>
                <img
                  src={UCSBDiplomaPreviewImage}
                  alt='UCSB Diploma Preview'
                  style={{ width: '100px', height: 'auto' }}
                />
              </div>
            )}{' '}
